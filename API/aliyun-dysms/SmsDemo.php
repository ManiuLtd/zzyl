...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIR3LhR5aZpwj6"; // AccessKeyId

        $accessKeySecret = "5odtTBHeKDbbN0pyNSJQgp18qtBVS4"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$code=0) {
        ...
        $request->setSignName("乐天游戏");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_125020975");
...
$response = SmsDemo::sendSms('15626519209', '349857');
