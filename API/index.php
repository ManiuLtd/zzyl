...
//签到
	...
	case 'GameVersion':
		...
		break;
	case 'GameVersionTest':
		include './action/GameVersionTest.php';
		break;
   ...
   //获取最新的一条特殊公告
	...
	// 微信分享
	case 'WXUserLogin':
		include './action/WXUserLogin.php';
		break;
       // 微信分享
        case 'ShareGameConfig':
                include './action/ShareGameConfig.php';
                break;
        case 'BindPhoneStatus': // 绑定状态
		include './action/BindPhoneStatus.php';
		break;
	case 'SendPhoneCode': // 发送验证码
		include './action/SendPhoneCode.php';
		break;
	case 'BindPhone': // 绑定手机
		include './action/BindPhone.php';
		break;
	case 'PhoneLogin': // 手机登录
	    include './action/PhoneLogin.php';
	    break;
	case 'ResetPasswdCode': // 重置密码 发送验证码
		include './action/ResetPasswdCode.php';
	    break;
	case 'ResetPasswd': // 重置密码 
		include './action/ResetPasswd.php';
	    break;
        case 'clubRecommend': // 俱乐部推荐
             include './action/clubRecommend.php';
        break;
	case 'testStatus': // 俱乐部推荐
        include './action/testStatus.php';
        break;
	default:
		$data['status'] = 0;
		$data['msg'] = '请求方法错误';
